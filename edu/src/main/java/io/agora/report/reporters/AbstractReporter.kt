...
import io.agora.edu.launch.AgoraEduSDK.reportUrl
...
abstract class AbstractReporter(
    ...
    private val service: ReportService = RetrofitManager.instance()
            .getService(reportUrl(), ReportService::class.java)
    ...
    fun report(body: Any, callback: EduCallback<Void>?) {
        ...
        service.report(appId, body).enqueue(object : retrofit2.Callback<ReportResp> {
